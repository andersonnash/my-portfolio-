...
<div className="grid-background mt-32 absolute inset-0 p-2 grid grid-cols-12 gap-2 transform -skew-y-4 scale-125">
...
<div className="relative">
  <h2 className="text-6xl text-white font-extrabold">Hi, I'm <span className="text-purple-500 text-">Nash</span> Anderson</h2>
</div>
